...
public class CalculatorLocator extends org.apache.axis.client.Service implements nl.backendtest.kvk.dp.Calculator {
    ...
    private java.lang.String CalculatorPort_address = "http://localhost:8080/kvk-dp-testbackend-webservice/services/CalculatorPort";
    ...
    public nl.backendtest.kvk.dp.CalculatorPortType getCalculatorPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            nl.backendtest.kvk.dp.CalculatorSoapBindingStub _stub = new nl.backendtest.kvk.dp.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (nl.backendtest.kvk.dp.CalculatorPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                nl.backendtest.kvk.dp.CalculatorSoapBindingStub _stub = new nl.backendtest.kvk.dp.CalculatorSoapBindingStub(new java.net.URL(CalculatorPort_address), this);
                _stub.setPortName(getCalculatorPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://dp.kvk.backendtest.nl", "Calculator");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://dp.kvk.backendtest.nl", "CalculatorPort"));
        }
